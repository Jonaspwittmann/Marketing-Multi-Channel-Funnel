...
const OnlyFansIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 24 24"
    fill="currentColor"
    {...props}
...
export default function App() {
  ...
  const getDestUI = () => {
    return { name: 'OnlyFans Chat', symbol: '', icon: OnlyFansIcon, agent: 'KI-Agent (Julia)', color: 'text-sky-400', bubble: 'bg-gradient-to-r from-sky-600/90 to-blue-600/90', bg: 'bg-sky-500/20 border-sky-500/30' };
  };
